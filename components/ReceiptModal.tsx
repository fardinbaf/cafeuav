        ...
        <div className="flex-1 overflow-y-auto p-12 bg-white printable-area">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-20 gap-4">
              ...
              <p className="font-black text-[10px] uppercase tracking-widest text-slate-400">Syncing Member Data...</p>
            </div>
          ) : (
            <div className="max-w-[280px] mx-auto text-center font-mono text-slate-900">
              ...
              <div className="border-y-2 border-dashed border-slate-200 py-6 my-6 text-[11px] text-left space-y-2">
                ...
                <div className="flex justify-between"><span>MEMBER:</span> <span className="font-black truncate ml-4 text-right uppercase tracking-tighter">{getDisplayName()}</span></div>
              </div>

              <div className="text-left mb-10">
                <div className="flex justify-between font-black text-[11px] mb-4 border-b border-slate-100 pb-2 uppercase">
